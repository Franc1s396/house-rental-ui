    ...
    <div>
      <el-table
        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            <el-button
                v-if="scope.row.orderStatus.name==='等待业主确认'"
    ...
    <div>
      <el-dialog title="订单详情" :visible.sync="orderDetailsDialog">
        ...
        <div slot="footer" class="dialog-footer">
          <el-button v-if="orderDetails.contractUrl!==undefined"
                     @click="viewContract"
                     type="primary">
            查看合同
          </el-button>
...
<script>
import {landlordOrderList, orderInfo, confirmOrder, cancelOrder} from "@/api/order";
...
export default {
  ...
  methods: {
    ...
    confirmOrder(orderId) {
      confirmOrder(orderId).then(resp => {
    ...
    getOrderList() {
      this.loading = true;
      landlordOrderList(this.queryParams).then(resp => {
